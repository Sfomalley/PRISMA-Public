...
preterm_output <- tb_theme1(preterm_tab) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Data Completeness [MNH01] (among all enrolled)</span>"),
    rows = 1:3
  ) %>%
  tab_row_group(
  ...
  row_group_order(groups = c("<span style='font-size: 18px'>Data Completeness [MNH01] (among all enrolled)</span>",
