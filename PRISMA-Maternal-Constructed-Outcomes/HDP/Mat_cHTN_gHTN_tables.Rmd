...
#### **Table 1a. Total number of BP measurements across visits until delivery (from MNH06) after the enrollment visit**
```{r}
chtn_table  %>% 
  `rownames<-` (c(
    "4 BP measurements, n (%)",
  ...
  pack_rows("Blood Pressure measurements from VISIT 1-6, n (%)", 1, 5, label_row_css = "color: steelblue;")
```
...
chtn_table  %>% 
  ...
  kable_paper(bootstrap_options = "striped", 
    ...
    pack_rows("Missing MNH08 at enrollment among those who delivered and have passed their enrollment visit window", 1, 1, label_row_css = "color: steelblue;") %>%
...
**Definition:** Blood pressure ≥140/90 mmHg before pregnancy or <20 weeks’ gestation and at least once >=20 weeks (2 measurements) OR
<br>

Use of anti-hypertensive medication before pregnancy or <20 weeks gestation with a history of hypertension and one BP measurement ≥140/90 at <20 weeks' gestation or >=20 weeks' gestation OR
<br>
...
chtn_table  %>% 
  ...
  kable_paper(bootstrap_options = "striped", 
    ...
    pack_rows("Onset of high BP <20 weeks' gestation", 1, 3, label_row_css = "color: steelblue;") %>%
  pack_rows("Onset of high BP <20 weeks' gestation - 2 measurements", 4, 6, label_row_css = "color: steelblue;") %>%
  ...
  pack_rows("Onset of high BP <20 weeks' gestation - 1 measurement + on treatment", 13, 15, label_row_css = "color: steelblue;") %>%
...
**Definition:** Blood pressure ≥140/90 mmHg twice ≥20 weeks gestation OR
Use of anti-hypertensive medication ≥20 weeks' gestation and 1 BP measurement >=20 weeks gestation of BP ≥140/90 OR
<br>

Severely high blood pressure: BP ≥160/110 mmHg once >=20 weeks gestation 
<br>
...
chtn_table  %>% 
  ...
  kable_paper(bootstrap_options = "striped", 
    ...
    pack_rows("Onset of high BP >=20 weeks' gestation", 1, 3, label_row_css = "color: steelblue;") %>%
    pack_rows("Onset of high BP >=20 week's gestation - 2 measurements", 4, 6, label_row_css = "color: steelblue;") %>%
   pack_rows("Onset of high BP >=20 week's gestation - 1 measurement + Treatment", 7, 9, label_row_css = "color: steelblue;") %>%
   pack_rows("Onset of severely high BP >=20 weeks' gestation", 10, 12, label_row_css = "color: steelblue;")

```
<br>

### Proteinuria and Severe Features
**Proteinuria at baseline:**
<br>
**Definition:** 
Urine dipstick 1+ or 2+ at baseline
<br>

**Gestational proteinuria:**
**Definition:** 
Urine dipstick 1+ or 2+ >=20 weeks' gestation or IPC among those who did not have baseline proteinuria and those without severe features)
<br>
...
#### **Table 2c. Proteinuria and Severe Features**
```{r}
chtn_table  %>% 
  `rownames<-` (c(
    "Baseline = Yes ",
  ...
  pack_rows("Severe Features", 7, 9, label_row_css = "color: steelblue;")
